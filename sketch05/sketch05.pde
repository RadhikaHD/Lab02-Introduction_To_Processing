...
if (currentColumn == 0) //regression line for milk 
{
  value  = 36.5;
  
    x = map(yearMin, yearMin, yearMax, plotX1, plotX2);
    y = map(value, dataMin, dataMax, plotY2, plotY1);
             
  value = 25.1;
    
    x1 = map(yearMax, yearMin, yearMax, plotX1, plotX2);
    y1 = map(value, dataMin, dataMax, plotY2, plotY1);
...
else if (currentColumn == 1) //regression line for tea
{
 value = 7.1;
              x = map(yearMin, yearMin, yearMax, plotX1, plotX2);
              y = map(value, dataMin, dataMax, plotY2, plotY1);
...
else if(currentColumn == 2) //regression line for coffee
{
    value = 33.1;
              x = map(yearMin, yearMin, yearMax, plotX1, plotX2);
              y = map(value, dataMin, dataMax, plotY2, plotY1);
